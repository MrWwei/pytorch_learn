...
# dataloaders = {'train':torch.utils.data.DataLoader(traindataset, batch_size=4,shuffle=True, num_workers=4),
#                'val':torch.utils.data.DataLoader(valdataset, batch_size=4,shuffle=True, num_workers=4)}
dataset_sizes = {x: len(image_datasets[x]) for x in ['train', 'val']}
print(dataset_sizes)
# dataset_sizes = len(traindataset)
# class_names = image_datasets['train'].classes
